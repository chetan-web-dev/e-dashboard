...
import { Navbar, NavLink, Nav, Col } from 'react-bootstrap-v5'
...

                {
                    auth ? <Navbar.Collapse id="navbar-dark-example" className="justify-content-left">
                        ...
                        : <Navbar.Collapse id="navbar-dark-example">
                            <Nav className="justify-content-left navbar-nav mb-2">
                                <NavLink className="d-inline p-2 text-white" href="#">Home</NavLink>
                                <NavLink className="d-inline p-2 text-white" href="/aboutus">About Us</NavLink>
                                <NavDropdown title="Contact Us" menuVariant="dark">
                                    <NavLink className="p-2 text-white" href="#">Telephone Directory</NavLink>
                                    <NavLink className="p-2 text-white" href="/contactus">Our Location</NavLink>
                                </NavDropdown>                                
                            </Nav>
                            <Nav className="justify-content-right navbar-nav ms-auto mb-2 col-lg-2">
